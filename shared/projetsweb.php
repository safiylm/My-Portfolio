...
<section id="projetsweb">
       ...
       <h2>Mes projets web</h2>
         ...
         <ul class="pagination">
           ...
           <li class="page-item"><button class="btn btn-light" onclick="openpage1()">1</button></li>
           <li class="page-item"><button class="btn btn-light" onclick="openpage2()">2</button></li>
           <li class="page-item"><button class="btn btn-light" onclick="openpage3()">3</button></li>
           <li class="page-item"><button class="btn btn-light" onclick="openpage4()">4</button></li>
   ...
   <script>
       ...
       function openpage2()
       {
           hideAll(); document.getElementById("p2").style.display= "flex";
       }
       
       function openpage3()
       {
           hideAll(); document.getElementById("p3").style.display= "flex";
       }
       
        function openpage4()
       {
           hideAll(); document.getElementById("p4").style.display= "flex";
       } 
